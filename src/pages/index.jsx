            ...
            <main>
                <section id="hero-index" className="h-screen w-full">
                    <div className="bg-black/50 p-10 h-full w-full flex flex-col justify-center items-center gap-3">
                        <h1 className="text-white text-5xl font-bold">
                            ¡Conoce el mundo pokemon y aventurate!
                        </h1>
                ...
                <section id="about-us" className="w-full bg-gradient-to-br from-red-600 to-brown-800 flex flex-col justify-center items-center gap-5 p-5 text-white ">
                    <div className="text-center space-y-5 w-3/4">
                        <h2 className="text-3xl font-bold">¿Qué es la Pokedex virtual?</h2>
                        <p className="text-xl">¡Bienvenido a Pokedex virtual, 
                        tu portal definitivo para todo lo relacionado con el fascinante mundo de los Pokémon! Aquí encontrarás una amplia gama de recursos, 
                        desde datos detallados sobre tus Pokémon favoritos hasta estrategias de batalla y consejos de entrenamiento. 
                        Sumérgete en nuestra extensa base de datos y descubre todo lo que necesitas saber para convertirte en un maestro Pokémon.</p>
                    </div>
                   <div className="">
